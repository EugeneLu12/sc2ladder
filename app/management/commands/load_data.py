    ...
    def handle(self, *args, **options):
        ...
        for player in player_list:
            ...
            if alias:
                ...
                print(ident, created)
                Player.players.filter(profile_id=profile_id, realm=realm, region=region).update(identity=ident)
            if game_link:
                Player.players.filter(profile_id=profile_id, realm=realm, region=region).update(game_link=game_link)
