...
from app.models.player import Player, Region, Rank, Race


class ApiTestCase(TestCase):
    def test_basic(self):
        Player.players.create_player('1', Region.US, Rank.GRANDMASTER, 'avilo', 'avilo#1337', Race.TERRAN, 5666, 30, 0,
                                     'aviNA', '123456789').save()
